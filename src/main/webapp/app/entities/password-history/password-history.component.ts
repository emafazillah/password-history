...
export class PasswordHistoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.passwordHistoryService
      ...
      .subscribe(
        (res: HttpResponse<IPasswordHistory[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IPasswordHistory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
